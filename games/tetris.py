...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (3, 24, 34)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = list(range(8))  # Fixed list of all possible actions. You should only edit the length
...
class Game(AbstractGame):
    ...
    def __init__(self, seed=None):
        self.env = gym.make("tetris_gymnasium/Tetris", render_mode="rgb_array")
